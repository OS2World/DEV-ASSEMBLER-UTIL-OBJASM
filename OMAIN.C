...
unsigned int    code_string = 40;   /* Stringizing Limit in Code */
unsigned int    data_string =  3;   /* Stringizing Limit in Data */
    ...
    while ( !at_eof ) {
        ...
        if ( rec_type == EOF ) {
            ...
            switch( rec_type ) {
              ...
              case COMENT:  coment( rec_length );           break;
