...
char *get_num( char *, unsigned long * );
...
void hint_insert( seg_idx, offset, hint_type, length )
    int             seg_idx;
    ...
    unsigned long   length;
{
    ...
    insert( (char *)hint_rec, hint_tree, hint_compare );
}
    ...
    unsigned long   *value;
{
    char            *pc;
    char            ch;
    unsigned long   dec_form;
    unsigned long   hex_form;
    int             is_hex;
    int             decable;
    int             char_ok;
